...
const agendaData: AgendaData = {
    ...
    dia4: {
        ...
        sessions: [
            { time: '08:30 - 09:00h', title: 'Leitura e aprovação da Síntese do 1º dia', type: 'Leitura', speaker: 'Secretariado', description: '' },
            { time: '09:00 - 09:05h', title: 'Painel I: Mecanismo de aumento do Financiamento do Sector de Saúde', type: 'Sessão', speaker: 'José Manuel', description: 'Apresentador do painel', fileUrl: "https://drive.google.com/uc?export=download&id=13DF-COhQllWuww9mrjI-QnQaURXZCxAO" },
            { time: '09:05 - 09:20h', title: 'Painel I: Mecanismo de aumento do Financiamento do Sector de Saúde', type: 'Apresentação', speaker: 'DPC', description: 'Apresentação do tema', fileUrl:"https://drive.google.com/uc?export=download&id=1Fq8snHvJ751bWNC-TQ4Se6b7KZIRtkiB" },
            { time: '09:20 - 09:45h', title: 'Painel I: Mecanismo de aumento do Financiamento do Sector de Saúde', type: 'Apresentação', speaker: 'Nelida Cabral, Daniel Chemane, Salomão Lourenço e Munira Abodou', description: 'Intervenções', fileUrl:"https://drive.google.com/uc?export=download&id=1PZN35zWXCwQu7wLlGR26j4Krpr-6FKcg" },
