   ...
   const agendaData: AgendaData = {
    dia1: {
        ...
        sessions: [
            ...
            { time: '09:00 - 09:10', title: 'Objectivos da reunião ', type: 'Apresentação', speaker: 'DNAM', description: '',  fileUrl: "" },
            { time: '09:10 - 09:30', title: 'Discurso de abertura por S. Excia Ministro da Saúde', type: 'Discurso', speaker: 'S. Excia. Ministro', description: "", fileUrl:'https://drive.google.com/uc?export=download&id=1NLh69dIeeDwMyVyYc1_lQXxPjWKLPVqY' },
    ...
    dia2: {
        ...
        sessions: [
            ...
            { time: '11:00 - 11:10h', title: 'Abordagem dos 5S', type: 'Apresentação', speaker: 'HCM', description: 'Iniciativas de Melhoria da Qualidade' },
            { time: '11:10 - 11:20h', title: 'Lixo Biomédico', type: 'Apresentação', speaker: 'Cidade de Maputo', description: 'Iniciativas de Melhoria da Qualidade', fileUrl: "https://drive.google.com/uc?export=download&id=1-8QI0OFLJgODALM7cj37S7PyUwKUyc-0" },
            { time: '11:20 - 11:30h', title: 'Esterilização', type: 'Apresentação', speaker: 'Provincia de Niassa', description: 'Iniciativas de Melhoria da Qualidade' },
            { time: '11:30 - 11:40h', title: 'Enfermaria Modelo', type: 'Apresentação', speaker: 'Provincia de Inhambane', description: 'Iniciativas de Melhoria da Qualidade', fileUrl: 'https://drive.google.com/uc?export=download&id=1OdUOsyry_XatKq2TAu5JJyJjB-pUBncg' },
            ...
            { time: '14:00 - 14:20h', title: 'Apetrechamento dos hospitais versos utilização e manutenção dos equipamentos', type: 'Apresentação', speaker: 'DNAM', description: '', fileUrl: 'https://drive.google.com/uc?export=download&id=161qd_RSxOOj5bEh2GsAoV8QNaw-gs5d8' },
    ...
    dia4: {
        ...
        sessions: [
            ...
            { time: '11:00 - 11:20h', title: 'Prioridades de Moçambique na Agenda de Lusaka', type: 'Apresentação', speaker: 'DPC', description: '', fileUrl: "https://drive.google.com/uc?export=download&id=1qVUAUM6N5D_I07S1hR_r_74ZLBle5Btc" },
            ...
            { time: '13:00 - 13:45h', title: 'Estratégia de integração das brigadas móveis na província ', type: 'Apresentação', speaker: 'Província de Tete', description: '', fileUrl: "https://drive.google.com/uc?export=download&id=1KZkm0sXkP6ijl-4ubLa7WhPjyEx-ALSd" },
