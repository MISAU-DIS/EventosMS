...
const agendaData: AgendaData = {
    ...
    dia3: {
        ...
        sessions: [
            ...
            { time: "14:40 - 15:00h", title: "Balanço do desempenho do ano 2024 e primeiro semestre 2025", "type": "Balanço", "speaker": "INS", "description": "", fileUrl: "https://docs.google.com/presentation/d/1d--5zTYnzxvCJ2QjG6_epreR9_dBcbn0/export/pptx" },
    ...
    dia4: {
        ...
        sessions: [
            { time: '08:30 - 09:00h', title: 'Leitura e aprovação da Síntese do 1º dia', type: 'Leitura', speaker: 'Secretariado', description: '' },
            { time: '09:00 - 09:05h', title: 'Painel I: Mecanismo de aumento do Financiamento do Sector de Saúde', type: 'Sessão', speaker: 'José Manuel, DPC, Nelida Cabral, Daniel Chemane, Salomão Lourenço e Munira Abodou', description: 'Situação_de_financiamento_e_alternativas_para_melhoria_CCS_2025_10_11', fileUrl: "https://drive.google.com/uc?export=download&id=13DF-COhQllWuww9mrjI-QnQaURXZCxAO" },
            { time: '09:05 - 09:20h', title: 'Painel I: Mecanismo de aumento do Financiamento do Sector de Saúde', type: 'Apresentação', speaker: 'José Manuel, DPC, Nelida Cabral, Daniel Chemane, Salomão Lourenço e Munira Abodou', description: 'NC - Apresentacao CCS - Panorama do financiamento da saude em Africa', fileUrl:"https://drive.google.com/uc?export=download&id=1Fq8snHvJ751bWNC-TQ4Se6b7KZIRtkiB" },
            { time: '09:20 - 09:45h', title: 'Painel I: Mecanismo de aumento do Financiamento do Sector de Saúde', type: 'Apresentação', speaker: 'José Manuel, DPC, Nelida Cabral, Daniel Chemane, Salomão Lourenço e Munira Abodou', description: 'Finaciamento_em_Saude_MP. `PRONTA 11.10.2025', fileUrl:"https://drive.google.com/uc?export=download&id=1PZN35zWXCwQu7wLlGR26j4Krpr-6FKcg" },
