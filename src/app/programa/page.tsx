...
const agendaData: AgendaData = {
    ...
    dia2: {
        ...
        sessions: [
            ...
            { time: '11:10 - 11:20h', title: 'Lixo Biomédico', type: 'Apresentação', speaker: 'Cidade de Maputo', description: 'Iniciativas de Melhoria da Qualidade', fileUrl: "https://drive.google.com/uc?export=download&id=1rYxnoI6Yn3dP5ICrB-THyavcRifTjBQ2" },
            ...
            { time: '11:30 - 11:40h', title: 'Enfermaria Modelo', type: 'Apresentação', speaker: 'Provincia de Inhambane', description: 'Iniciativas de Melhoria da Qualidade', fileUrl: 'https://drive.google.com/uc?export=download&id=1roaOFG5KBVmrN-FNq6JCp_t6InW5cjVC' },
            { time: '11:40 - 11:50h', title: 'Estratégias do Programa de Prevenção e Controle de Infecções', type: 'Apresentação', speaker: 'DNAM', description: '', fileUrl: "https://drive.google.com/uc?export=download&id=1_5BbXkWv1bdU6bSNSrAI4HSoGb43ovxc" },
            ...
            { time: '14:00 - 14:20h', title: 'Apetrechamento dos hospitais versos utilização e manutenção dos equipamentos', type: 'Apresentação', speaker: 'DNAM', description: '', fileUrl: 'https://drive.google.com/uc?export=download&id=1h0HE7p32ATUrp-EaKtoSJVCksHzBCgUZ' },
