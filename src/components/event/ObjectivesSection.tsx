    ...
    <section className="py-16 px-4 bg-gradient-to-b from-orange-50 to-white">
      <div className="container mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-orange-700 text-white rounded-xl p-6 sm:p-8 shadow-lg mb-10"
        >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {eventConfig.specificObjectives.map((objective, index) => (
            ...
            >
              <span className="inline-flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-700 rounded-lg font-bold text-sm mb-3">
                {index + 1}
              </span>
