      ...
      <div className="w-full max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 xl:gap-16 items-stretch">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true, amount: 0.2 }}
            className="lg:col-span-5 flex items-center order-2 lg:order-1 self-stretch lg:min-h-[520px]"
          >
            <p className="text-gray-700 text-base sm:text-lg md:text-xl lg:text-[1.55rem] xl:text-[1.7rem] 2xl:text-[1.85rem] leading-relaxed lg:leading-[1.9] text-justify w-full">
